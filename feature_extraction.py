...
class FeatureExtraction:
    ...
    def train_topic_model_with_bertopic(self, product_name, n_topic=5, star_rating_range=None):
        ...
        model.fit_transform(text_pp.documents)
    ...
    def get_topics_per_month(self):
        ...
        word_tfidf_per_time, word_set = self._get_word_tfidf_per_month(topic_word_per_month, topic_idx=0)
